...
public class CreateNewClipRequestDTOV1 {
    @JsonProperty("url")
    private String url;
    ...
    public CreateNewClipRequestDTOV1() {}

    public CreateNewClipRequestDTOV1(String url, String startTime, String endTime, List<String> tags, String subject) {
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        CreateNewClipRequestDTOV1 that = (CreateNewClipRequestDTOV1) o;
    ...
    public String toString() {
        return "CreateNewClipRequestDTOV1{" +
                "url='" + url + '\'' +
                ", startTime='" + startTime + '\'' +
                ", endTime='" + endTime + '\'' +
                ", tags=" + tags +
